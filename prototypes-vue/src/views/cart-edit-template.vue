<template>
    <ion-page>
        <ion-content mode="ios">
            ...
            <ion-list lines="none">
                <ion-item color="tertiary">
                    ...
                    <ion-label>
                        <h2><b>ชื่อบริษัทขนส่งสินค้า</b></h2>
                    </ion-label>
                ...
                <ion-item color="tertiary" class="ion-padding-vertical">
                    ...
                    <ion-button class="no-shadow ion-no-margin" mode="md" color="danger" size="small" shape="round"
                        slot="end">
            ...
            <ion-list class="ion-margin-top" lines="full">
                <ion-item class="ion-no-padding" color="tertiary" lines="none">
                    <ion-label class="ion-padding-start">
                        <h3><b>รายการที่สั่ง (2 ชิ้น)</b></h3>
                    </ion-label>
                </ion-item>
                    ...
                    <ion-grid class="ion-no-padding text-hidden">
                        ...
                        <ion-row class="ion-no-padding ion-align-items-center ion-padding-top">
                            <ion-col justify-content-center align-items-center
                                class="ion-no-padding ion-text-center ion-padding-start" size="auto">
        ...
        <ion-footer class="ion-no-border">
            <ion-button color="danger" class="ion-no-margin" expand="full" type="submit">สั่งสินค้า</ion-button>
        </ion-footer>
    </ion-page>
</template>
