...
@Component({
  selector: 'app-demo-kyc-tel',
  templateUrl: './demo-kyc-tel.page.html',
  styleUrls: ['./demo-kyc-tel.page.scss'],
})
export class DemoKycTelPage implements OnInit {
  ...
  ionViewDidEnter() {
    if (this.svc.kycTel) {
      this.fg.patchValue(this.svc.kycTel);
    }
  }
