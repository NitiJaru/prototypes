...
@Component({
  selector: 'app-demo-kyc-address-idcard',
  templateUrl: './demo-kyc-address-idcard.page.html',
  styleUrls: ['./demo-kyc-address-idcard.page.scss'],
})
export class DemoKycAddressIdcardPage implements OnInit {
  ...
  onSave() {
    ...
    if (this.fg.valid) {
      this.svc.kycAddressIdCard = this.fg.value;
      this.navCtrl.back();
    }
  }
